...
window.tagcloud = (function (win, doc) { // ns
    ...
    TagCloud.prototype = {
        ...
        _getItems: function () {
            ...
            for (var i = 0; i < length; i++) {
                ...
                item.element.style.backgroundColor = randomColor()
                items.push(item);
            }
    ...
    function randomColor() {
        var items = ['255 255 0', '255 130 71', '99 184 255', '144 238 144', '255 165 0', '255 0 255', '0 255 255', '67 205 128', '255 250 250'];
        var rgb = items[Math.floor(Math.random() * items.length)];
        return "rgb(" + rgb + ")";
    }
